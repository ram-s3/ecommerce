...
import { Table, Paper, TableHead, TableContainer, TableBody, TableRow, TableCell } from "@mui/material";
...
export async function loader() {
    ...
    const response = await fetch("http://localhost:8080/admin/getorders");
...
export async function action({ request, params }) {
    ...
    const response = await fetch("http://localhost:8080/admin/order/setstatus/" + id,
        {
